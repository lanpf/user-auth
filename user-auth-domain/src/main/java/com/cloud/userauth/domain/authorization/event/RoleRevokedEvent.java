...
@Getter
public class RoleRevokedEvent extends AbstractDomainEvent {
    private final GrantId grantId;
    private final UserId userId;
    private final RoleCode roleCode;

    public RoleRevokedEvent(DomainEventId eventId, Instant occurredAt, GrantId grantId, UserId userId, RoleCode roleCode) {
