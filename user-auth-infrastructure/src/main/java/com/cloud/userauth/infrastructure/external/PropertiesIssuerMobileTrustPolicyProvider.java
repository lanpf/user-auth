...
public class PropertiesIssuerMobileTrustPolicyProvider implements IssuerMobileTrustPolicyProvider {
    ...
    public IssuerMobileTrustPolicy policyFor(CredentialIssuer issuer) {
        boolean trusted = properties.getIssuerPolicies().entrySet().stream()
                ...
                .map(ExternalIdentityProperties.IssuerPolicyProperties::getTrustedMobile)
