...
import com.cloud.userauth.interfaces.mapper.mapstruct.AuthorizationAdminRestMapStructMapper;
...
class UserAuthorizationAdminControllerTest {
    ...
    private static MockMvc mockMvc(UserAuthorizationQueryFacade queryFacade) {
        return MockMvcBuilders.standaloneSetup(
                        new UserAuthorizationAdminController(
                                new StubCommandFacade(), queryFacade,
                                Mappers.getMapper(AuthorizationAdminRestMapStructMapper.class)))
