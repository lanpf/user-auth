...
class SessionHandoffCommandServiceTest {
    ...
    void shouldConsumeTicketAndCreateBrowserSession() {
        ...
        ExchangeSessionHandoffOutput output = service.exchange(new ExchangeSessionHandoffCommand(
                "ticket",
    ...
    private static final class Sessions implements BrowserSessionStore {
        ...
        public CreatedSession create(
            ...
            return new CreatedSession("browser-session", idle);
        }
